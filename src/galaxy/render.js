...
import starUrl from "../assets/galaxy/star_noise.png";
import milkywayUrl from "../assets/galaxy/milkyway.jpg";
import diskUrl from "../assets/galaxy/accretion_disk.png";
...
export function createScene(renderer) {
  ...
  const bloomPass = new UnrealBloomPass(new Vector2(128, 128), 0.0, 0.0, 0.0);
